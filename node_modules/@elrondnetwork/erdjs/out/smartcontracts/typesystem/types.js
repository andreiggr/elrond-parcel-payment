...
class Type {
    ...
    hasJavascriptConstructor(javascriptConstructorName) {
        return reflection_1.hasJavascriptConstructor(this, javascriptConstructorName);
    }
    hasJavascriptConstructorInHierarchy(javascriptConstructorName) {
        return reflection_1.getJavascriptConstructorsNamesInHierarchy(this, prototype => prototype.belongsToTypesystem).includes(javascriptConstructorName);
    }
    getTypeParameters() {
    ...
    isAssignableFrom(other) {
        ...
        let javascriptConstructorNamesInHierarchyOfOther = reflection_1.getJavascriptConstructorsNamesInHierarchy(other, prototype => prototype.belongsToTypesystem);
