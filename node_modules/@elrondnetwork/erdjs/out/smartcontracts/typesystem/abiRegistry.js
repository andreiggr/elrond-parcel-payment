...
class AbiRegistry {
    ...
    getStruct(name) {
        let result = this.customTypes.find((e) => e.getName() == name && e.hasJavascriptConstructor(struct_1.StructType.name));
    ...
    getEnum(name) {
        let result = this.customTypes.find((e) => e.getName() == name && e.hasJavascriptConstructor(enum_1.EnumType.name));
